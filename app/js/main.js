	...
	$('#fullpage').fullpage({
		...
		afterLoad: function(link,index) {
			...
			if (index == 1) {
				...
				$('#page1 .bg').animate({'opacity':'1'},-100);
			}
			if (index == 2) {
